...
function ExperienceItem(props) {
    return (
        <div>
            <h5>{props.title}</h5>
            <h6>{props.company}</h6>
            <span className='experience-icons'><FontAwesomeIcon icon={faCalendarAlt} /> {props.startDate} - {props.endDate}</span>
            <span className='experience-icons'><FontAwesomeIcon icon={faLocationDot} /> {props.location}</span>
            <ul>
